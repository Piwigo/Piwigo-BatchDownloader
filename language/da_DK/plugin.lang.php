...
$lang['Download info'] = 'Downloadinformation';
...
$lang['Edit the set'] = 'Rediger samlingen';
...
$lang['You choose to download %d pictures, but the system is limited to %d. You can edit the set, or the last %d pictures will not be downloaded.'] = 'Du har valgt at downloade %d billeder, men systemet er begrænset til %d. Du skal redigere samlingen, ellers vil de sidste %d billeder ikke blive downloadet.';
$lang['done'] = 'færdig';
$lang['download'] = 'download';
$lang['hours'] = 'timer';
$lang['real number of archives can differ'] = 'det reelle antal arkiver kan variere';
$lang['Set type'] = 'Opsæt type';
$lang['The archive is downloading, if the download doesn\'t start automatically please <a href="%s">click here</a>'] = 'Arkivet bliver downloadet, hvis den ikke går i gang automatisk, så <a href="%s">klik her</a>';
...
$lang['%s plugin detected, albums will be downloadable according to permissions.'] = 'Plugin\'en %s fundet, albummer kan downloades alt efter rettighederne.';