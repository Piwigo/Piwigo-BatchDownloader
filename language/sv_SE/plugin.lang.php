...
$lang['Maximum number of photos per download set'] = 'Max antal bilder/nedladdnings paket';
$lang['Maximum photo size'] = 'Max bild storlek';
...
$lang['Remove from download set'] = 'Ta bort från dedladdningspaket';
$lang['Return to download page'] = 'Återgå till nedladdningssida';
$lang['Set type'] = 'Paket typ';
$lang['Starting download Archive #%d will destroy Archive #%d, be sure you finish the download. Continue ?'] = 'Start av arkiv  nedladdning #%d förstör arkiv #%d, är du säker på att du vill avsluta nedladdning.
Fortsätt?';
...
$lang['Unable to find ZipArchive PHP extension, Batch Downloader will use PclZip instead, but with degraded performance.'] = 'ZipArchive PHP extension kan inte hittas, Batch nedladdaren kommer att använda PclZip istället, men då med lägre prestanda.';
$lang['User collection'] = 'Användarsamling';
$lang['User groups'] = 'Använargrupper';
$lang['Warning: Only registered users can use Batch Downloader.'] = 'Varning: Bara registrerade användare kan bruka Batch Nedladdaren.';
...
$lang['Archive comment'] = 'Arkiv komentar';
$lang['Archive prefix'] = 'Arkiv prefix';
$lang['Archives'] = 'Arkiv';
$lang['Batch Downloader'] = 'Batch nedladdare';
...
$lang['Download history'] = 'Nedladdnings historik';
$lang['Download info'] = 'Nedladdnings info';
$lang['Download links'] = 'Nedladdnings länkar';
$lang['Download permissions'] = 'Nedladdnings befogenhet';
$lang['Download set deleted'] = 'Nedladdnings paket raderat';
