...
<form action="{$F_ACTION}" method="post" class="batch_dwn_form" id="request_form">
  <div class="batch_dwn_input_group">
    <label for="firstname">{'firstname'|translate}<span>*</span></label>
    <input type="text" name="firstname" id="firstname" size="60">
    <p>{'This field is required'|translate}</p>
  </div>
  <div class="batch_dwn_input_group">
    <label for="lastname">{'lastname'|translate}<span>*</span></label>
...
{html_options name=batch_dwn_request_size options=$batch_dwn_request_size selected="original"}
  </div>
